...
public class CameraMover : MonoBehaviour
{
    ...
    [Space]
    [SerializeField] private Vector2 _minMaxY = new Vector2(-5, 5);
    ...
    private void Update()
    {
        ...
        transform.position = new Vector3(transform.position.x, Mathf.Clamp(transform.position.y, _minMaxY.x, _minMaxY.y), transform.position.z);
        transform.position = Vector3.ClampMagnitude(transform.position, _maxDistance);
    }
