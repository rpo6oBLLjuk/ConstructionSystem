...
public class StyleSchemeConfig : ScriptableObject
{
    ...
    [field: SerializeField] public Color ButtonBackgroundColor { get; private set; } = new Color32(226, 107, 0, 255);
    [field: SerializeField] public Color ButtonHighlightColor { get; private set; } = new Color32(226, 107, 0, 255);
    [field: SerializeField] public Color ButtonPressColor { get; private set; } = new Color32(226, 107, 0, 255);
    [field: SerializeField] public Color ButtonTextColor { get; private set; } = new Color32(226, 107, 0, 255);
    ...
    public Color GetColorByType(ColorShemeType type)
    {
        return type switch
        {
            ...
            ColorShemeType.Button => ButtonBackgroundColor,
            ColorShemeType.ButtonText => ButtonTextColor,
        };
    }
